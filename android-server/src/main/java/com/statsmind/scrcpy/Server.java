...
import com.statsmind.scrcpy.websocket.WebSocketProxy;
...
public final class Server {
    ...
    private static class Completion {
        ...
        synchronized void addCompleted(String name, boolean fatalError) {
            Ln.i("some thread exit:" + fatalError + ",this" + name);
    ...
    private static void scrcpy(Options options) throws IOException, ConfigurationException {
        ...
        try {
            ...
            for (AsyncProcessor asyncProcessor : asyncProcessors) {
                asyncProcessor.start((name, fatalError) -> {
                    completion.addCompleted(name, fatalError);
                });
            }
