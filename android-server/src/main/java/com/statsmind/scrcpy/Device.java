...
import com.statsmind.scrcpy.wrappers.*;
...
public final class Device {
    ...
    public static MediaProjectionManager getMediaProjectionManager() {
        return SERVICE_MANAGER.getMediaProjectionManager();
    }
    ...
    public Point getPhysicalPoint(Position position) {
        ...
        if (!unlockedVideoSize.equals(clientVideoSize)) {
            ...
            Ln.e("unlockedVideoSize=" + unlockedVideoSize + ",clientVideoSize=" + clientVideoSize);
            return null;
        }
